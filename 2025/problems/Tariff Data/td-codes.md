Tariff Database Code Key 

Codes are used in many of the fields in the tariff database. The key for these codes is shown as follows. 

A. Rate type codes (see fields with “rate_type_code” in field name) 

Code  Duty computation method 
...
Q1 refers to the first unit of quantity value in U.S. trade data. Q2 refers to the second unit of quantity in 

U.S. trade data. 

B. Import program codes (used in the col1_special_text field). See the U.S. Harmonized Tariff 

Schedule (HTS) for more complete descriptions of these programs. 
...
E*  Certain countries or products excluded from CBI eligibility IL  Israel Special Rate (duty -free treatment) 
...
K Agreement on Trade in Pharmaceutical Products (duty -free 

treatment); 

KR  Korea Special Rate 

L Uruguay Round Concessions on Intermediate Chemicals for 

Dyes (duty -free treatment) 
...
P+  Dominican Republic -Central American Plus Rate (DR -CAFTA 
...
C. Codes for countries excluded from receiving GSP benefits (used in the gsp_ctry_excluded 

field) Note: if multiple countries excluded, codes will be combined. 
...
D. Description of quantity codes (used in the quantity_1_code and quantity_2_code fields) 
...
Not available. This code used when more than one units of quantity exist for the component 10-digit subheadings 
